/*
    ...
    ALTERAÇÕES:
        ...
        | 22/05/25	| ADD COLUMNS NOMERESP, CPFRESP IN ANAMNESE					| ENFER., ODONTO., NUTRI.		|
        ...
        | 26/05/25	| CREATE TABLE ALMOXERIFADO									| COMPRAS						|
...
ALTER TABLE PERMIUSUA
	ADD CONSTRAINT FK_PERMIUSUA_USUARIO
...
ALTER TABLE PRODUTO
	ADD CONSTRAINT FK_PRODUTO_LOTE
    FOREIGN KEY(ID_LOTE)
    REFERENCES LOTE(IDLOTE);
    
ALTER TABLE PRODUTO
	ADD CONSTRAINT FK_PRODUTO_ALMOXERIFADO
    FOREIGN KEY(ID_ALMOX)
    REFERENCES ALMOXERIFADO(IDALMOX);
...
ALTER TABLE ALMOXERIFADO
	ADD CONSTRAINT FK_ALMOXERIFADO_SETOR
    FOREIGN KEY(ID_SETOR)
    REFERENCES SETOR(IDSETOR);
