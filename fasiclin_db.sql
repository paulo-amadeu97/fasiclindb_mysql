/*
    ...
    ALTERAÇÕES:
        ...
        ---------------------------------------------------------------------------------------------------------
        | 21/05/25	| ADD TABLE LOCCOLET  										| BIOMEDICINA					|
		| 21/05/25	| ADD COLUMNS MOTCANC, FATORRH, TPSANGUI FROM RESULEXAME	| BIOMEDICIONA					|
        | 21/05/25	| ADD DEFAULT VALUE FOR STATUSPAC FROM PACIENTE				| *								|
        | 21/05/25	| REMOVE COLUMN DESCRICAO FROM SOLIODONTO					| ODONTOLOGIA					|
        | 21/05/25	| ADD COLUMN MOTNEG FROM SOLIODONTO							| ODONTOLOGIA					|
        | 22/05/25	| ADD COLUMNS NOMERESP, CPFRESP FROM ANAMNESE				| ENFER., ODONTO., NUTRI.		|
        | 22/05/25	| REMOVE CONSTRAINT NOT NULL IN ID_PROFISSIO FROM AGENDA	| AGENDA						|
        ´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´
*/
